...
des=False
edulai,edulaj=0,0
img1 = ImageTk.PhotoImage(Image.open("ma.png").resize((20, 20), Image.Resampling.LANCZOS))
img2=ImageTk.PhotoImage(Image.open("home.png").resize((20, 20), Image.Resampling.LANCZOS))
img3=ImageTk.PhotoImage(Image.open("heart.png").resize((20, 20), Image.Resampling.LANCZOS))
start_ah=False
...
docimg = [ImageTk.PhotoImage(Image.open(i).resize((root1.winfo_screenwidth() - 200, root1.winfo_screenheight() - 200), Image.Resampling.LANCZOS)) for i in imag]
...
docimg1 = [ImageTk.PhotoImage(Image.open(i).resize((root5.winfo_screenwidth() - 200, root5.winfo_screenheight() - 200), Image.Resampling.LANCZOS)) for i in imag1]
